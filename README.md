...
│   ├── replay.py          # Real-time event replay with configurable speed
...
├── dashboard/
│   └── index.html         # Live dashboard — SSE-connected, Chart.js charts
├── data/
│   ├── store_layout.json  # Zone definitions, camera roles, open hours
│   └── pos_transactions.csv
├── docs/
│   ├── DESIGN.md          # Architecture + AI-assisted decisions
│   └── CHOICES.md         # Engineering decisions with full reasoning
├── docker-compose.yml
├── Dockerfile
└── requirements.txt
```
